...
const Result = () => {
  ...
  return (
    <>
      <div className="flex flex-col bg-primary-blue p-5 rounded-lg space-y-4 mt-12 text-dark-100 mx-auto">
        ...
        <div className="flex flex-col space-y-0">
          ...
          {/* Speciality */}
          <div className="text-lg text-dark-900">Sports Physiotherapist</div>
