...
const ResetPassword = (props) => {
  ...
  const submit_form = async () => {
    ...
    try {
      ...
      if (pass.password.trim() !== pass.cPassword.trim() || pass.password.trim() !== "") {
        Swal.fire({
          icon: "error",
          title: "Oops...",
      ...
      setLoad(true);
      let res = await axios.post(`http://127.0.0.1:4000/auth/setpassword/:${props.match.params.token}`, postData);
