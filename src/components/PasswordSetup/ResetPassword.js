              ...
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input
                    ...
                    type="checkbox"
                    class="w-4 h-4 border border-gray-300 rounded-lg bg-gray-50 focus:ring-3 focus:ring-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-600 dark:ring-offset-gray-800"
                    required=""
                  />
                </div>
              </div>
