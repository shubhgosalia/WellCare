        ...
        newStep.map((step, index) => {
          return (
            <>
              ...
              >
                <div className="relative flex flex-col items-center text-primary-blue">
                  <div
                  ...
                  ${step.selected
                        ? "bg-primary-blue text-white font-bold border border-primary-blue "
                        : ""
                      }`}
                  >
                    {step.completed ? (
                ...
                <div
                  className={`flex-auto border-t-2 transition duration-500 ease-in-out  ${step.completed ? "border-primary-blue" : "border-gray-300 "
                    }  `}
                ></div>
              </div>
            </>
