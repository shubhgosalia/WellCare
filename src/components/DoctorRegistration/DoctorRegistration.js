  ...
  const handleClick = (direction) => {
    ...
    if (direction === "next") {
      ...
      if (resp)
        ...
        Swal.fire({ icon: "error", title: "Oops...", text: "Incomplete field(s)..." });
    } else {
      newStep--;
    }
  ...
  return (
    <>
      ...
      <div className="mx-auto mt-6 rounded-2xl bg-white pb-2 shadow-xl md:w-1/2">
        {/* Stepper */}
        <h2 className="pt-5 pl-8 text-xl font-bold leading-tight tracking-tight text-blue-600 md:text-2xl dark:text-white">
          Expert Registration
        </h2>
