        ...
        <div className="flex flex-col space-y-0">
          ...
          {/* Speciality if doctor */}
          {
            isDoctor ?
              ...
              :
              <div className="text-sm">{apt.doctor_id.specialization === "" ? apt.doctor_id.category : apt.doctor_id.specialization}</div>
          }
        </div>

        {/* Timings */}
        <div className="flex flex-col space-y-0 font-semibold text-base">
          <div className="">{apt.startTime}:00 - {apt.endTime}:00 hrs</div>
